...
varMainDir=/opt/docker/homelab-docker

find $varMainDir/services -mindepth 1 -maxdepth 3 -type d -exec ln -sbf $varMainDir/.env {}/.env \;

# Now, remove the .env~ files
find $varMainDir/services -mindepth 1 -maxdepth 3 -type d -exec rm -fI {}/.env~ \;
